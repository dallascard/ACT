...
class AttentionCnnAct(object):
    def __init__(self, args, vocab, embeddings_matrix):
        ...
        self.model = AttentionCnnActModule(args, vocab, embeddings_matrix).to(self.device)
...
class AttentionCnnActModule(nn.Module):
    def __init__(self, args, vocab, embeddings_matrix):
        super(AttentionCnnActModule, self).__init__()
        self.device = args.device
